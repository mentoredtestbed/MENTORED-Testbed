...
ROOT_KUBE_CONFIG_PATH = "/home/bhmeyer/.kube/config"
...
class ExperimentExecution(models.Model):
    ...
    def run(self):
        ...
        def f(yaml_path, experiment_execution, user_name, exp_id):
            ...
            with tempfile.NamedTemporaryFile(mode="w") as temp:
                ...
                temp.flush()
                # yaml_path = '/home/bruno/mentored-backend/mentored-master/core/experiment_example_simple.yml'
                yaml_path = temp.name
    ...
    def start_warmup(self, yaml_path, me):
        ...
        # cmd_apply = f"kubectl apply -f {yaml_path} --kubeconfig=/home/bruno/.kube/config -n mentored"
    ...
    def stop(self, yaml_path, me=None):
        ...
        # cmd_apply = f"kubectl delete -f {yaml_path} --kubeconfig=/home/bruno/.kube/config -n mentored"
        # output_check = subprocess.check_output(cmd_apply, shell=True, universal_newlines=True)
