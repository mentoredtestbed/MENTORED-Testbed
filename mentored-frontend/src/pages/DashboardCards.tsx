        ...
        <div className="container-fluid group mt-5vh">
            <div className='row justify-content-between'>
                ...
                <Card className='Updates-card Main-card ' title={t('card.tutorialtitle')}>
                    {t('card.tutorialtext')} <a href="https://mentored-testbed.cafeexpresso.rnp.br/tutorial">mentored-testbed.cafeexpresso.rnp.br/tutorial</a>.
                </Card>
